                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button
                                            ...
                                            disabled={authState === "loading"}
                                            className="w-full py-3 px-4 bg-card border border-border text-foreground rounded-xl hover:bg-secondary/10 hover:border-border transition-all duration-200 font-medium flex items-center justify-center gap-3 disabled:opacity-50"
                                        >
